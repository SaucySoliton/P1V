...
'
'
' Check the ram for a pre-loaded program
'
boot                    rdword  address,#$0004+2        'if pbase address valid, start program
                        cmp     address,#$0010  wz
         if_z           jmp     #ram_loaded             ' TODO Should the program be marked dirty
                                                        ' in case of reset?
...
ram_loaded              rdbyte  address,#$0004          'if xtal/pll enabled, start up now
